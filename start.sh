#!/bin/sh
env SPARK_HOME=/opt/mapr/spark/spark-1.6.1 /opt/mapr/spark/spark-1.6.1/bin/spark-submit --master yarn-cluster \
...
/home/user03/twitter_demo/twitter_streaming_demo/lib/httpclient-4.5.2.jar,\
/home/user03/twitter_demo/twitter_streaming_demo/lib/httpcore-4.4.4.jar,\
